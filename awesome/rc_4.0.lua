...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "s", function () awful.spawn(soundGui) end),
    awful.key({ modkey }, "u", function () awful.spawn(lock) end),
...
awful.rules.rules = {
    ...
    { rule = { class = "Pidgin" },
      ...
      callback = function(c)
        c:geometry({ x = 2561, y = 428, width = 880, height = 682 })
      end
    },
    ...
    { rule = { class = "Pidgin", name = "Buddy List" },
      properties = { screen = 2, tag = screen[2].tags[1] },
      callback = function(c)
        c:geometry({ x = 3444, y = 428, width = 315, height = 910 })
      end
    },
    { rule = { class = "TeamSpeak 3" },
      properties = { screen = 2, tag = screen[2].tags[1] }, 
      callback = function (c)
          c:geometry({ x = 2561, y = 1110, width = 879, height = 807})
      end },
    { rule = { class = "Seafile-applet" },
      properties = { screen = 2, tag = screen[2].tags[1] }, 
      callback = function (c)
          c:geometry({ x = 3443, y = 1340, width = 322, height = 585})
      end },
    { rule = { class = "seafile-applet" },
      properties = { screen = 2, tag = screen[2].tags[1] }, 
      callback = function (c)
    ...
    { rule = { class = "Chromium-browser-chromium", name = "Signal" }, -- "crx_bikioccmkafdpakkkcpdbppfkghcmihk" },
